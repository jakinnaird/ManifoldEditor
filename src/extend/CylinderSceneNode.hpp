...
#define ESNT_CYLINDER MAKE_IRR_ID('c', 'l', 'd', 'r')

class CylinderSceneNode : public irr::scene::IMeshSceneNode
{
private:
	...
	irr::f32 m_Radius;
	irr::f32 m_Length;
	irr::u32 m_Tesselation;
	bool m_CloseTop;
	irr::f32 m_Oblique;

public:
	CylinderSceneNode(irr::f32 radius, irr::f32 length, irr::u32 tesselation,
		bool closeTop, irr::f32 oblique, irr::scene::ISceneNode* parent,
		irr::scene::ISceneManager* mgr, irr::s32 id,
		const irr::core::vector3df& position = irr::core::vector3df(0, 0, 0),
		const irr::core::vector3df& rotation = irr::core::vector3df(0, 0, 0),
		const irr::core::vector3df& scale = irr::core::vector3df(1.0f, 1.0f, 1.0f));
	virtual ~CylinderSceneNode(void);
	...
	virtual irr::scene::ESCENE_NODE_TYPE getType(void) const { return (irr::scene::ESCENE_NODE_TYPE)ESNT_CYLINDER; }
